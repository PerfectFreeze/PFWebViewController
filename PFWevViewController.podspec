#
#  Be sure to run `pod spec lint PFWevViewController.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/PerfectFreeze/PFWebViewController.git", :tag => "v#{s.version.to_s}" }
